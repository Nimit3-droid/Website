...
const Contact = (props: { style: React.CSSProperties | undefined; }) => {
  return (
    <div className="absolute z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2" style={props.style}>
